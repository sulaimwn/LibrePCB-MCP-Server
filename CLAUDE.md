# Alternate-client entry point

Read [AGENTS.md](AGENTS.md), [STATUS.md](STATUS.md), [PLAN.md](PLAN.md),
[SPEC.md](SPEC.md) and [HANDOFF.md](HANDOFF.md). This is the same project used
...
`docs/DAY3.md`, `docs/DAY4.md`, `docs/DAY5.md`, `docs/DAY6.md`,
`docs/OWNER_TRIAL.md` and `evidence/2026-09-14-day6/README.md`.
