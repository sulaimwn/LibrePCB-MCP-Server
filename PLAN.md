...
| 5 — Sep 14 | Reliability | Test locked projects, stale snapshots, malformed files, missing binaries, timeouts, unsafe paths, export collisions, and rejected edits. Harden only tools in scope. Test switching coding clients using the handoff instructions. | 5–7 h |
